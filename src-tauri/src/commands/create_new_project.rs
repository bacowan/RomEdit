...
#[tauri::command]
pub fn create_new_project(project_name: String, rom_path: String, project_directory_path: String) -> Result<String, String> {
    if Path::new(project_directory_path.as_str()).exists() {
    ...
    let full_path = project_directory_path_buffer.join("project.rep");
